...
exports.compareQueryASTS = void 0;
const diffObjects = (obj1, obj2, isAst) => {
    let result = {};
...
const isSubQuery = (value) => {
    if (typeof value === 'object' && 'expr' in value && 'ast' in value['expr'])
        return true;
    else
        return false;
};
...
const compareQueryASTS = (studentAST, solutionAST) => {
...
exports.compareQueryASTS = compareQueryASTS;
