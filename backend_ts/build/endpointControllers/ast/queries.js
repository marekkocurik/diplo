...
exports.queries = [
    {
        "id": 1,
        "original": "SELECT * FROM CD.FACILITIES;",
    ...
    {
        "id": 2,
        "original": "SELECT NAME, MEMBERCOST FROM CD.FACILITIES;",
        "normalized": "SELECT FACILITIES.NAME, FACILITIES.MEMBERCOST FROM CD.FACILITIES;"
    },
    {
        "id": 3,
        "original": "SELECT * FROM CD.FACILITIES WHERE MEMBERCOST > 0;",
    ...
    {
        "id": 4,
        "original": "SELECT FACID, NAME, MEMBERCOST, MONTHLYMAINTENANCE FROM CD.FACILITIES WHERE MEMBERCOST > 0 AND (MEMBERCOST < MONTHLYMAINTENANCE/50.0);",
    ...
    {
        "id": 5,
        "original": "SELECT * FROM CD.FACILITIES WHERE NAME LIKE '%Tennis%';",
    ...
    {
        "id": 6,
        "original": "SELECT * FROM CD.FACILITIES WHERE FACID IN (1,5);",
    ...
    {
        "id": 7,
        "original": "SELECT NAME, CASE WHEN (MONTHLYMAINTENANCE > 100) THEN 'expensive' ELSE 'cheap' END AS COST FROM CD.FACILITIES;",
    ...
    {
        "id": 8,
        "original": "SELECT MEMID, SURNAME, FIRSTNAME, JOINDATE FROM CD.MEMBERS WHERE JOINDATE >= '2012-09-01';",
    ...
    {
        "id": 9,
        "original": "SELECT DISTINCT SURNAME FROM CD.MEMBERS ORDER BY SURNAME LIMIT 10;",
        "normalized": "SELECT DISTINCT MEMBERS.SURNAME FROM CD.MEMBERS ORDER BY MEMBERS.SURNAME LIMIT 10;"
    },
    {
        "id": 10,
        "original": "SELECT SURNAME FROM CD.MEMBERS UNION SELECT NAME FROM CD.FACILITIES;",
        "normalized": "SELECT MEMBERS.SURNAME FROM CD.MEMBERS UNION SELECT FACILITIES.NAME FROM CD.FACILITIES;"
    },
    {
        "id": 11,
        "original": "SELECT MAX(JOINDATE) AS LATEST FROM CD.MEMBERS;",
        "normalized": "SELECT MAX(MEMBERS.JOINDATE) AS LATEST FROM CD.MEMBERS;"
    },
    {
        "id": 12,
        "original": "SELECT FIRSTNAME, SURNAME, JOINDATE FROM CD.MEMBERS WHERE JOINDATE = (SELECT MAX(JOINDATE) FROM CD.MEMBERS);",
    ...
    {
        "id": 13,
        "original": "SELECT BKS.STARTTIME FROM CD.BOOKINGS BKS INNER JOIN CD.MEMBERS MEMS ON MEMS.MEMID = BKS.MEMID WHERE MEMS.FIRSTNAME='David' AND MEMS.SURNAME='Farrell';",
    ...
    {
        "id": 14,
        "original": "SELECT BKS.STARTTIME AS START, FACS.NAME AS NAME FROM CD.FACILITIES FACS INNER JOIN CD.BOOKINGS BKS ON FACS.FACID = BKS.FACID WHERE FACS.NAME IN ('Tennis Court 2','Tennis Court 1') AND BKS.STARTTIME >= '2012-09-21' AND BKS.STARTTIME < '2012-09-22' ORDER BY BKS.STARTTIME;",
    ...
    {
        "id": 15,
        "original": "SELECT DISTINCT RECS.FIRSTNAME AS FIRSTNAME, RECS.SURNAME AS SURNAME FROM CD.MEMBERS MEMS INNER JOIN CD.MEMBERS RECS ON RECS.MEMID = MEMS.RECOMMENDEDBY ORDER BY SURNAME, FIRSTNAME;",
    ...
    {
        "id": 16,
        "original": "SELECT MEMS.FIRSTNAME AS MEMFNAME, MEMS.SURNAME AS MEMSNAME, RECS.FIRSTNAME AS RECFNAME, RECS.SURNAME AS RECSNAME FROM CD.MEMBERS MEMS LEFT OUTER JOIN CD.MEMBERS RECS ON RECS.MEMID = MEMS.RECOMMENDEDBY ORDER BY MEMSNAME, MEMFNAME;",
    ...
    {
        "id": 17,
        "original": "SELECT DISTINCT MEMS.FIRSTNAME || ' ' || MEMS.SURNAME AS MEMBER, FACS.NAME AS FACILITY FROM CD.MEMBERS MEMS INNER JOIN CD.BOOKINGS BKS ON MEMS.MEMID = BKS.MEMID INNER JOIN CD.FACILITIES FACS ON BKS.FACID = FACS.FACID WHERE FACS.NAME IN ('Tennis Court 2','Tennis Court 1') ORDER BY MEMBER, FACILITY;",
    ...
    {
        "id": 19,
        "original": "SELECT DISTINCT MEMS.FIRSTNAME || ' ' || MEMS.SURNAME AS MEMBER, (SELECT RECS.FIRSTNAME || ' ' || RECS.SURNAME AS RECOMMENDER FROM CD.MEMBERS RECS WHERE RECS.MEMID = MEMS.RECOMMENDEDBY ) FROM CD.MEMBERS MEMS ORDER BY MEMBER;",
    ...
    {
        "id": 20,
        "original": "SELECT MEMBER, FACILITY, COST FROM ( SELECT MEMS.FIRSTNAME || ' ' || MEMS.SURNAME AS MEMBER, FACS.NAME AS FACILITY, CASE WHEN MEMS.MEMID = 0 THEN BKS.SLOTS*FACS.GUESTCOST ELSE BKS.SLOTS*FACS.MEMBERCOST END AS COST FROM CD.MEMBERS MEMS INNER JOIN CD.BOOKINGS BKS ON MEMS.MEMID = BKS.MEMID INNER JOIN CD.FACILITIES FACS ON BKS.FACID = FACS.FACID WHERE BKS.STARTTIME >= '2012-09-14' AND BKS.STARTTIME < '2012-09-15' ) AS BOOKINGS WHERE COST > 30 ORDER BY COST DESC;",
    ...
    {
        "id": 21,
        "original": "INSERT INTO CD.FACILITIES (FACID, NAME, MEMBERCOST, GUESTCOST, INITIALOUTLAY, MONTHLYMAINTENANCE) VALUES (9, 'Spa', 20, 30, 100000, 800);",
    ...
    {
        "id": 22,
        "original": "INSERT INTO CD.FACILITIES (FACID, NAME, MEMBERCOST, GUESTCOST, INITIALOUTLAY, MONTHLYMAINTENANCE) VALUES (9, 'Spa', 20, 30, 100000, 800), (10, 'Squash Court 2', 3.5, 17.5, 5000, 80);",
    ...
    {
        "id": 23,
        "original": "INSERT INTO CD.FACILITIES (FACID, NAME, MEMBERCOST, GUESTCOST, INITIALOUTLAY, MONTHLYMAINTENANCE) SELECT (SELECT MAX(FACID) FROM CD.FACILITIES)+1, 'Spa', 20, 30, 100000, 800;",
    ...
    {
        "id": 24,
        "original": "UPDATE CD.FACILITIES SET INITIALOUTLAY = 10000 WHERE FACID = 1;",
        "normalized": "UPDATE CD.FACILITIES SET FACILITIES.INITIALOUTLAY = 10000 WHERE FACILITIES.FACID = 1;"
    },
    {
        "id": 25,
        "original": "UPDATE CD.FACILITIES SET MEMBERCOST = 6, GUESTCOST = 30 WHERE FACID IN (0,1);",
        "normalized": "UPDATE CD.FACILITIES SET FACILITIES.MEMBERCOST = 6, FACILITIES.GUESTCOST = 30 WHERE FACILITIES.FACID IN (0,1);"
    },
    {
        "id": 26,
        "original": "UPDATE CD.FACILITIES FACS SET MEMBERCOST = (SELECT MEMBERCOST * 1.1 FROM CD.FACILITIES WHERE FACID = 0), GUESTCOST = (SELECT GUESTCOST * 1.1 FROM CD.FACILITIES WHERE FACID = 0) WHERE FACS.FACID = 1;",
    ...
    {
        "id": 27,
        "original": "DELETE FROM CD.BOOKINGS;",
        "normalized": "DELETE FROM CD.BOOKINGS;"
    },
    {
        "id": 28,
        "original": "DELETE FROM CD.MEMBERS WHERE MEMID = 37;",
        "normalized": "DELETE FROM CD.MEMBERS WHERE MEMBERS.MEMID = 37;"
    },
    {
        "id": 29,
        "original": "DELETE FROM CD.MEMBERS WHERE MEMID NOT IN (SELECT MEMID FROM CD.BOOKINGS);",
        "normalized": "DELETE FROM CD.MEMBERS WHERE MEMBERS.MEMID NOT IN (SELECT MEMBERS.MEMID FROM CD.BOOKINGS);"
    },
    {
        "id": 30,
        "original": "SELECT COUNT(*) FROM CD.FACILITIES;",
        "normalized": "SELECT COUNT(*) FROM CD.FACILITIES;"
    },
    {
        "id": 31,
        "original": "SELECT COUNT(*) FROM CD.FACILITIES WHERE GUESTCOST >= 10;",
        "normalized": "SELECT COUNT(*) FROM CD.FACILITIES WHERE FACILITIES.GUESTCOST >= 10;"
    },
    {
        "id": 32,
        "original": "SELECT RECOMMENDEDBY, COUNT(*) FROM CD.MEMBERS WHERE RECOMMENDEDBY IS NOT NULL GROUP BY RECOMMENDEDBY ORDER BY RECOMMENDEDBY;",
    ...
    {
        "id": 33,
        "original": "SELECT FACID, SUM(SLOTS) AS \"TOTAL SLOTS\" FROM CD.BOOKINGS GROUP BY FACID ORDER BY FACID;",
    ...
    {
        "id": 34,
        "original": "SELECT FACID, SUM(SLOTS) AS \"TOTAL SLOTS\" FROM CD.BOOKINGS WHERE STARTTIME >= '2012-09-01' AND STARTTIME < '2012-10-01' GROUP BY FACID ORDER BY SUM(SLOTS);",
    ...
    {
        "id": 35,
        "original": "SELECT FACID, EXTRACT(MONTH FROM STARTTIME) AS MONTH, SUM(SLOTS) AS \"TOTAL SLOTS\" FROM CD.BOOKINGS WHERE EXTRACT(YEAR FROM STARTTIME) = 2012 GROUP BY FACID, MONTH ORDER BY FACID, MONTH;",
    ...
    {
        "id": 36,
        "original": "SELECT COUNT(DISTINCT MEMID) FROM CD.BOOKINGS;",
        "normalized": "SELECT COUNT(DISTINCT BOOKINGS.MEMID) FROM CD.BOOKINGS;"
    },
    {
        "id": 37,
        "original": "SELECT FACID, SUM(SLOTS) AS \"TOTAL SLOTS\" FROM CD.BOOKINGS GROUP BY FACID HAVING SUM(SLOTS) > 1000 ORDER BY FACID;",
    ...
    {
        "id": 38,
        "original": "SELECT FACS.NAME, SUM(SLOTS * CASE WHEN MEMID = 0 THEN FACS.GUESTCOST ELSE FACS.MEMBERCOST END) AS REVENUE FROM CD.BOOKINGS BKS INNER JOIN CD.FACILITIES FACS ON BKS.FACID = FACS.FACID GROUP BY FACS.NAME ORDER BY REVENUE;",
    ...
    {
        "id": 39,
        "original": "SELECT NAME, REVENUE FROM ( SELECT FACS.NAME, SUM(CASE WHEN MEMID = 0 THEN SLOTS * FACS.GUESTCOST ELSE SLOTS * MEMBERCOST END) AS REVENUE FROM CD.BOOKINGS BKS INNER JOIN CD.FACILITIES FACS ON BKS.FACID = FACS.FACID GROUP BY FACS.NAME ) AS AGG WHERE REVENUE < 1000 ORDER BY REVENUE;",
    ...
    {
        "id": 40,
        "original": "SELECT FACID, SUM(SLOTS) AS \"TOTAL SLOTS\" FROM CD.BOOKINGS GROUP BY FACID ORDER BY SUM(SLOTS) DESC LIMIT 1;",
    ...
    {
        "id": 41,
        "original": "SELECT FACID, EXTRACT(MONTH FROM STARTTIME) AS MONTH, SUM(SLOTS) AS SLOTS FROM CD.BOOKINGS WHERE STARTTIME >= '2012-01-01' AND STARTTIME < '2013-01-01' GROUP BY ROLLUP(FACID, MONTH) ORDER BY FACID, MONTH;",
    ...
    {
        "id": 42,
        "original": "SELECT FACS.FACID, FACS.NAME, TRIM(TO_CHAR(SUM(BKS.SLOTS)/2.0, '9999999999999999D99')) AS \"TOTAL HOURS\" FROM CD.BOOKINGS BKS INNER JOIN CD.FACILITIES FACS ON FACS.FACID = BKS.FACID GROUP BY FACS.FACID, FACS.NAME ORDER BY FACS.FACID;",
    ...
    {
        "id": 43,
        "original": "SELECT MEMS.SURNAME, MEMS.FIRSTNAME, MEMS.MEMID, MIN(BKS.STARTTIME) AS STARTTIME FROM CD.BOOKINGS BKS INNER JOIN CD.MEMBERS MEMS ON MEMS.MEMID = BKS.MEMID WHERE STARTTIME >= '2012-09-01' GROUP BY MEMS.SURNAME, MEMS.FIRSTNAME, MEMS.MEMID ORDER BY MEMS.MEMID;",
    ...
    {
        "id": 44,
        "original": "SELECT COUNT(*) OVER(), FIRSTNAME, SURNAME FROM CD.MEMBERS ORDER BY JOINDATE;",
        "normalized": "SELECT COUNT(*) OVER(), MEMBERS.FIRSTNAME, MEMBERS.SURNAME FROM CD.MEMBERS ORDER BY MEMBERS.JOINDATE;"
    },
    {
        "id": 45,
        "original": "SELECT ROW_NUMBER() OVER(ORDER BY JOINDATE), FIRSTNAME, SURNAME FROM CD.MEMBERS ORDER BY JOINDATE;",
    ...
    {
        "id": 46,
        "original": "SELECT FACID, TOTAL FROM ( SELECT FACID, SUM(SLOTS) TOTAL, RANK() OVER (ORDER BY SUM(SLOTS) DESC) RANK FROM CD.BOOKINGS GROUP BY FACID ) AS RANKED WHERE RANK = 1;",
    ...
    {
        "id": 47,
        "original": "SELECT FIRSTNAME, SURNAME, ((SUM(BKS.SLOTS)+10)/20)*10 AS HOURS, RANK() OVER (ORDER BY ((SUM(BKS.SLOTS)+10)/20)*10 DESC) AS RANK FROM CD.BOOKINGS BKS INNER JOIN CD.MEMBERS MEMS ON BKS.MEMID = MEMS.MEMID GROUP BY MEMS.MEMID ORDER BY RANK, SURNAME, FIRSTNAME;",
    ...
    {
        "id": 48,
        "original": "SELECT NAME, RANK FROM ( SELECT FACS.NAME AS NAME, RANK() OVER (ORDER BY SUM(CASE WHEN MEMID = 0 THEN SLOTS * FACS.GUESTCOST ELSE SLOTS * MEMBERCOST END) DESC) AS RANK FROM CD.BOOKINGS BKS INNER JOIN CD.FACILITIES FACS ON BKS.FACID = FACS.FACID GROUP BY FACS.NAME ) AS SUBQ WHERE RANK <= 3 ORDER BY RANK;",
    ...
    {
        "id": 49,
        "original": "SELECT FACS.NAME AS NAME, FACS.INITIALOUTLAY/((SUM(CASE WHEN MEMID = 0 THEN SLOTS * FACS.GUESTCOST ELSE SLOTS * MEMBERCOST END)/3) - FACS.MONTHLYMAINTENANCE) AS MONTHS FROM CD.BOOKINGS BKS INNER JOIN CD.FACILITIES FACS ON BKS.FACID = FACS.FACID GROUP BY FACS.FACID ORDER BY NAME;",
    ...
    {
        "id": 51,
        "original": "SELECT TIMESTAMP '2012-08-31 01:00:00';",
        "normalized": "SELECT TIMESTAMP '2012-08-31 01:00:00';"
    },
    {
        "id": 52,
        "original": "SELECT TIMESTAMP '2012-08-31 01:00:00' - TIMESTAMP '2012-07-30 01:00:00' AS INTERVAL;",
        "normalized": "SELECT TIMESTAMP '2012-08-31 01:00:00' - TIMESTAMP '2012-07-30 01:00:00' AS INTERVAL;"
    },
    {
        "id": 53,
        "original": "SELECT GENERATE_SERIES(TIMESTAMP '2012-10-01', TIMESTAMP '2012-10-31', INTERVAL '1 day') AS TS;",
        "normalized": "SELECT GENERATE_SERIES(TIMESTAMP '2012-10-01', TIMESTAMP '2012-10-31', INTERVAL '1 day') AS TS;"
    },
    {
        "id": 54,
        "original": "SELECT EXTRACT(DAY FROM TIMESTAMP '2012-08-31');",
        "normalized": "SELECT EXTRACT(DAY FROM TIMESTAMP '2012-08-31');"
    },
    {
        "id": 55,
        "original": "SELECT EXTRACT(EPOCH FROM (TIMESTAMP '2012-09-02 00:00:00' - '2012-08-31 01:00:00'));",
        "normalized": "SELECT EXTRACT(EPOCH FROM (TIMESTAMP '2012-09-02 00:00:00' - '2012-08-31 01:00:00'));"
    },
    {
        "id": 56,
        "original": "SELECT EXTRACT(MONTH FROM CAL.MONTH) AS MONTH, (CAL.MONTH + INTERVAL '1 month') - CAL.MONTH AS LENGTH FROM ( SELECT GENERATE_SERIES(TIMESTAMP '2012-01-01', TIMESTAMP '2012-12-01', INTERVAL '1 month') AS MONTH ) CAL ORDER BY MONTH;",
    ...
    {
        "id": 57,
        "original": "SELECT (DATE_TRUNC('month',TS.TESTTS) + INTERVAL '1 month') - DATE_TRUNC('day', TS.TESTTS) AS REMAINING FROM (SELECT TIMESTAMP '2012-02-11 01:00:00' AS TESTTS) TS;",
    ...
    {
        "id": 58,
        "original": "SELECT STARTTIME, STARTTIME + SLOTS*(INTERVAL '30 minutes') ENDTIME FROM CD.BOOKINGS ORDER BY ENDTIME DESC, STARTTIME DESC LIMIT 10;",
    ...
    {
        "id": 61,
        "original": "SELECT SURNAME || ', ' || FIRSTNAME AS NAME FROM CD.MEMBERS;",
    ...
    {
        "id": 63,
        "original": "SELECT * FROM CD.FACILITIES WHERE UPPER(NAME) LIKE 'TENNIS%';",
