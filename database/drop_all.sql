...
DROP ROLE IF EXISTS r_recommendations_select;
DROP ROLE IF EXISTS r_recommendations_insert;
DROP ROLE IF EXISTS r_recommendations_update;
...
DROP TABLE users.recommendations;
