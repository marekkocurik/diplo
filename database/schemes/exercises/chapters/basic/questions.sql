...
(1, 'Retrieve everything from a table', 'How can you retrieve all the information from the cd.facilities table?'),
...
(1, 'Matching against multiple possible values', 'How can you retrieve the details of facilities with ID 1 and 5? Try to do it without using the <c>OR</c> operator.'),
