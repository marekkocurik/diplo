...
const chapters = [{
    chapter: 1,
    name: "SELECT",
    exercises: [{ id: 1, name: "SELECT ALL" }, { id: 2, name: "SELECT ONLY" }]
  },
  {
    chapter: 2,
    name: "WHERE",
  ...
  const exercises = [{ id: 1, name: "SELECT ALL" }, { id: 2, name: "SELECT ONLY" }];
...
function ExerciseTree() {
  ...
  const handleExerciseClick = (n) => {
    ...
    return (
        ...
        <div style={{ width: "20%", height: "100vh", float: "left", backgroundColor: "grey" }}>
        </div>
